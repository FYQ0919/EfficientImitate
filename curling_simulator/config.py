...
# GUI
scale = 30 # 40
large_scale = scale * 1.9
plane_length = int(length * scale) + 1
gui_length = plane_length
plane_width = int(width * scale) + 1
gui_width = int(width * scale) + 1
# gui_width = int(width * scale) * 5 + 1
ccc=48
...
# 网络输入
# 属于 gym env 中的设置, 应写在gym env class 的init函数中
network_input_size = (6, 32, 32)#21,6 (6, 128, 128) (3, 210, 160)
# simplified_input_size = (4, 128, 128)

# 浅红/浅黄
light_red = (1.0, 0.6, 0.6)
light_yellow = (0.6, 1.0, 0.6)
